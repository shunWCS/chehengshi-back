...
public class UpdateTool {
     ...
     */
    public static void copyNullProperties(Object source, Object target) throws CustomException {
        if(source==null){
            throw new CustomException(Constants.RESP_STATUS_BADREQUEST,"修改的资源不存在");
        }
